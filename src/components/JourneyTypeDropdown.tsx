...
export default function JourneyTypeDropdown() {
  ...
  const menuContent = ["Round trip", "One way", "Multi-city"];
  ...
  return (
    <ul className="flex flex-col gap-2 absolute bg-dropdownBg z-10">
